...
//Add missing console property in IE
if (typeof console == "undefined") {
  this.console = {log: function() {}};
}

//Initiate after jQuery has loaded
(function ( $ ) {
  ...
  //Helper function to convert objects to arguments for RPC requests
  ...
  //Internal Session object Constructor
  function Session(loc, key, txt){
    ...
    this.getFile = function(path, success){
      return $.get(this.getFileURL(path), success);
    };
    ...
    this.getObject = function(name, data, success){
      ...
      return $.get(this.getLoc() + "R/" + name + "/json", data, success);
    };

    this.getStdout = function(success){
      return $.get(this.getLoc() + "stdout/text", success);
    };

    this.getConsole = function(success){
      return $.get(this.getLoc() + "console/text", success);
    };
  }
  ...
  function Package(url) {
    ...
    //exported properties of Package class
    this.call = r_fun_call;
    this.plot = plot;
    this.rpc = rpc;    
